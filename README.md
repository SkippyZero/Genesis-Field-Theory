...
- write proofs, derivations, and Greek-symbol-heavy operator definitions  
...
- MIT (open usage)  
- CC-BY-SA (open but attribution required)  
- “All rights reserved” (if you want control)  

I can generate the license file for you.
